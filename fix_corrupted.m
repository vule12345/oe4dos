...
% low_pass_mask = fspecial('average', 3);
% low_pass_response = imfilter(negative, low_pass_mask,'replicate');
% high_pas_compontent = negative - low_pass_response;
% negative_filtered = negative + high_pas_compontent;
...
contrast_enhanced = histeq(negative_filtered);
